...
final class Category {
    ...
    static func resolveSystemCategoryKey(_ value: String) -> String {
        ...
        let explicitLegacyAliases: [String: String] = [
            ...
            "personal care": "category.expense.personalCare",
            "個人護理": "category.expense.personalCare",
            "个人护理": "category.expense.personalCare",
            "beauty & personal care": "category.expense.personalCare",
            "美容護理": "category.expense.personalCare",
            "美容护理": "category.expense.personalCare",
