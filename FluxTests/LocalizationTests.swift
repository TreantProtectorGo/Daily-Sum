    ...
    func testTravelCurrencyCopyMatchesCurrentWordingAcrossLanguages() {
        let expectedValues: [String: [String: String]] = [
            ...
            "zh-Hans": [
                ...
                "settings.exchangeRate.configuration": "外币模式开关",
                ...
                "settings.exchangeRate.configuration.footer": "关闭后，新交易不会预设使用外币。 \n自动模式按所在地区设定货币；手动模式则沿用你选定的货币。",
            ...
            "zh-Hant": [
                ...
                "settings.exchangeRate.configuration": "外幣模式開關",
