    ...
    func testTravelCurrencyCopyMatchesCurrentWordingAcrossLanguages() {
        let expectedValues: [String: [String: String]] = [
            "en": [
                ...
                "settings.exchangeRate.configuration.footer": "When off, new transactions will not default to foreign currency. When on, Automatic follows your location; Manual uses your selected currency.",
            ...
            "zh-Hans": [
                ...
                "settings.exchangeRate.configuration.footer": "关闭后，新交易不会默认使用外币。开启后，自动模式会跟随你的位置；手动模式会使用你所选的货币。",
            ...
            "zh-Hant": [
                ...
                "settings.exchangeRate.configuration.footer": "關閉後，新交易不會預設使用外幣。開啟後，自動模式會跟隨你的位置；手動模式會使用你所選的貨幣。",
